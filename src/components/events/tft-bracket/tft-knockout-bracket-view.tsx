  ...
  return (
    ...
    >
      ...
      >
        ...
        {renderSlot(k('v1_16_m3_t1', 'B54', 'C54'), '6.88%', '62.59%', '9.22%', '2.78%', '1.65vh')}
        {renderSlot(k('v1_16_m3_t2', 'B55', 'C55'), '6.88%', '65.46%', '9.22%', '2.78%', '1.65vh')}
        {renderSlot(k('v1_16_m4_t1', 'B58', 'C58'), '6.88%', '72.22%', '9.22%', '2.87%', '1.65vh')}
        {renderSlot(k('v1_16_m4_t2', 'B59', 'C59'), '6.88%', '75.19%', '9.22%', '2.78%', '1.65vh')}
        ...
        {renderSlot(k('tuKet_m3', 'D54', 'E54', 'D55', 'E55'), '18.07%', '62.59%', '9.53%', '5.65%', '1.95vh')}
        ...
        {renderSlot(k('chungKet_left', 'J52', 'I52', 'J53', 'I53'), '39.22%', '57.13%', '9.74%', '5.65%', '2.15vh', 800)}
        ...
        {renderSlot(k('tuKet_m7', 'R54', 'S54', 'R55', 'S55'), '72.45%', '62.59%', '9.53%', '5.65%', '1.95vh')}
        ...
        {renderSlot(k('v1_16_m7_t1', 'T54', 'U54'), '83.96%', '62.59%', '9.22%', '2.78%', '1.65vh')}
        {renderSlot(k('v1_16_m7_t2', 'T55', 'U55'), '83.96%', '65.46%', '9.22%', '2.78%', '1.65vh')}
        {renderSlot(k('v1_16_m8_t1', 'T58', 'U58'), '83.96%', '72.22%', '9.22%', '2.87%', '1.65vh')}
        {renderSlot(k('v1_16_m8_t2', 'T59', 'U59'), '83.96%', '75.19%', '9.22%', '2.78%', '1.65vh')}
