...
export default function GiftTicketModal({
  ...
  event,
  onSuccess,
}: GiftTicketModalProps): React.JSX.Element {
      ...
      try {
        ...
        const resp: AxiosResponse<{ fields: CheckoutRuntimeField[] }> =
          await baseHttpServiceInstance.get(
            `/marketplace/events/${event.slug}/forms/checkout/runtime`
          );
  ...
  // Load per-ticket (holder) form configuration
  useEffect(() => {
    const fetchTicketForm = async () => {
      ...
      try {
        const resp: AxiosResponse<{ fields: CheckoutRuntimeField[] }> =
          await baseHttpServiceInstance.get(
            `/marketplace/events/${event.slug}/forms/ticket/runtime`
          );
                          ...
                          visible && (
                            <Grid item xs={12} md={6}>
                              <FormControl fullWidth required={nameCfg?.required}>
                                ...
                                />
                                {nameCfg?.note && <FormHelperText>{nameCfg.note}</FormHelperText>}
                              </FormControl>
                            </Grid>
                          )
                        );
                            ...
                            <Grid item xs={12} md={6}>
                              <FormControl fullWidth required={emailCfg?.required}>
                                ...
                                <OutlinedInput
                                  ...
                                  label={label}
                                />
                                {emailCfg?.note && <FormHelperText>{emailCfg.note}</FormHelperText>}
                              </FormControl>
                            </Grid>
                          )
                        );
                          ...
                          visible && (
                            <Grid item xs={12} md={6}>
                              <FormControl fullWidth required={phoneCfg?.required}>
                                ...
                                />
                                {phoneCfg?.note && <FormHelperText>{phoneCfg.note}</FormHelperText>}
                              </FormControl>
                            </Grid>
                          )
                        );
                            ...
                            <Grid item xs={12} md={6}>
                              <FormControl fullWidth required={addrCfg?.required}>
                                ...
                                <OutlinedInput
                                  ...
                                  label={label}
                                />
                                {addrCfg?.note && <FormHelperText>{addrCfg.note}</FormHelperText>}
                              </FormControl>
                            </Grid>
                          )
                        );
                          ...
                          visible && (
                            <Grid item xs={12} md={6}>
                              <FormControl fullWidth required={dobCfg?.required}>
                                ...
                                />
                                {dobCfg?.note && <FormHelperText>{dobCfg.note}</FormHelperText>}
                              </FormControl>
                            </Grid>
                          )
                        );
                          ...
                          visible && (
                            <Grid item xs={12} md={6}>
                              <FormControl fullWidth required={idCfg?.required}>
                                ...
                                />
                                {idCfg?.note && <FormHelperText>{idCfg.note}</FormHelperText>}
                              </FormControl>
                            </Grid>
                          )
                        );
