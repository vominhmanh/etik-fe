...
import { Avatar, Box, Stack, Typography, Select, MenuItem, FormControl, InputLabel, OutlinedInput, InputAdornment, FormControlLabel, Checkbox } from '@mui/material';
  ...
  return (
    <Stack spacing={3}>
      <Box sx={{ px: { xs: 0, md: 20 } }} >
        <Card sx={{ mb: 3 }}>
          <CardHeader title="Thông tin người nhận lời mời" />
          <Divider />
          <CardContent>
            <Grid container spacing={2}>
              <Grid xs={12}>
                <Stack spacing={0.5}>
                  <Typography variant="body2" sx={{ fontWeight: 500 }}>{tt(`Danh xưng và Họ tên (tuỳ chọn)`, `Title & Full Name (optional)`)}</Typography>
