...
import backgroundImage from '@/images/van-hoa-viet-nam/Screenshot_105.jpg';
...
import { LocalizedLink } from '@/components/van-hoa-viet-nam/localized-link';
import PubgGalaPageHeader from '@/components/van-hoa-viet-nam/ui/pubggala-page-header';
import PubgGalaFooter from '@/components/van-hoa-viet-nam/ui/pubggala-footer';
...
const FacebookSDK = dynamic(
  () => import('@/components/van-hoa-viet-nam/FacebookSDK'),
  { ssr: false }
);

const FBPost = dynamic(
  () => import('@/components/van-hoa-viet-nam/FBPost'),
  { ssr: false }
);
        ...
        <div className="absolute inset-0 z-10 flex items-center pt-8 md:pt-14 px-4">
          <Container maxWidth="xl" className="w-full">
            <div className="flex flex-col gap-4 md:gap-6 w-full" data-aos="fade-right">
              ...
              >
                {tt('VĂN HÓA VIỆT NAM', 'THE CULTURE OF VIETNAM')}
              </h1>
              ...
              <p
                ...
                dangerouslySetInnerHTML={{
                  __html: tt(
                    'Nơi tôn vinh tinh hoa Việt.',
                    'Here we honor the best of Vietnam.'
                  )
                    .replace(/\n\n/g, '<br /><br />')
                    .replace(/\n/g, '<br />'),
                }}
              ...
              {!isVotingDisabled() && (
                ...
                >
                  <Link
                    href="https://etik.vn/events/show-dien-van-hoa-viet-nam-726"
                    style={{
                      display: 'flex',
                      flexDirection: 'row',
                  ...
                  >
                    <div className="w-40 sm:w-48 md:w-[220px] h-12 sm:h-14 md:h-[60px]" style={{ position: 'relative' }}>
                      <Image src={buttonBackgroundImage} alt={tt('Đặt vé ngay', 'Order now')} fill priority />
                      {/* Text overlay */}
                      <span
