...
export default function Page(): React.JSX.Element {
  const params = { event_slug: 'tft-2026-duo-final' };
  ...
  const fetchLeaderboard = async () => {
    ...
    try {
      ...
      const response: AxiosResponse<Leaderboard> = await baseHttpServiceInstance.get(
        `/special_events/tft-2026/leaderboards/DUO - Final Leaderboard`
      );
  ...
  return (
    ...
    >
      <Box component="img"
        src={'https://media.etik.vn/tft-2026/BANG_XEP_HANG_CAP_DOI.png'}
        alt="Event Image"
        sx={{
          width: 'auto',
          height: '100%',
