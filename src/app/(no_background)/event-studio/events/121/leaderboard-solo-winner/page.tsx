...
export default function Page(): React.JSX.Element {
  const params = { event_slug: 'tft-2026-solo-winner' };
  ...
  const fetchLeaderboard = async () => {
    ...
    try {
      ...
      const response: AxiosResponse<Leaderboard> = await baseHttpServiceInstance.get(
        `/special_events/tft-2026/leaderboards/SOLO - Leaderboard - Nhánh thắng`
      );
  ...
  return (
    ...
    >
      <Box component="img"
        src={'https://media.etik.vn/tft-2026/BANG_XEP_HANG_CA_NHAN.png'}
        alt="Event Image"
        sx={{
          width: 'auto',
          height: '100%',
