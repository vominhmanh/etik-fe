  ...
  const MENU_ITEMS = [
    {
      ...
      icon: <ListDashes />,
      label: 'Cấu hình',
      component: <Config event_id={params.event_id} />,
    },
    {
      id: 'prizes',
      icon: <Gift />,
      label: 'Giải thưởng',
      component: <PrizePage eventId={params.event_id} />,
    },
    {
      id: 'history',
      icon: <SpinnerBall />,
    ...
    },
    {
      ...
      component:
        <Typography>
          <Button
            variant="contained"
            href={`/event-studio/events/${params.event_id}/mini-app-lucky-wheel`}
            target="_blank"
  ...
  async function checkConfig() {
    ...
    try {
      ...
      const response: AxiosResponse<CheckConfigResponse> = await baseHttpServiceInstance.get(
        `/event-studio/events/${event_id}/mini-app-lucky-wheel/configs/check-config`
      );
  ...
  return (
    <Stack spacing={3}>
      ...
      {!configExists ? (
        <>
          <div>
            <Typography variant="h4"> Mini App "Lucky Wheel"</Typography>
          </div>
          <Stack spacing={3}>
            <Typography variant="body2">
              Mini App "Lucky Wheel" hỗ trợ nhà tổ chức sự kiện tạo mini-game vòng quay may mắn
            </Typography>
          </Stack>
          <div>
            <Button
        ...
        <>
          <div>
            <Typography variant="h4">Cấu hình Mini App "Lucky Wheel"</Typography>
          </div>
