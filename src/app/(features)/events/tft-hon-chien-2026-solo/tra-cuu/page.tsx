...
export default function Page(): React.JSX.Element {
  const params = { event_slug: 'tft-hon-chien-2026-solo' }
      ...
      const fetchEventDetails = async () => {
        try {
          ...
          const [eventResponse, showsResponse]: [AxiosResponse<EventResponse>, AxiosResponse<Show[]>] = await Promise.all([
            ...
            baseHttpServiceInstance.get('/special_events/tft-2026-solo/shows'),
          ]);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res: AxiosResponse<SearchTransactionDTO> = await baseHttpServiceInstance.get('/special_events/tft-2026-solo/search-transaction', {
        params: {
          show_id: showId,
                ...
                <Stack spacing={2} sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '450px', maxWidth: '100%' }}>
                  ...
                  <Table sx={{ backgroundColor: "transparent" }}>
                    <TableBody>
                      ...
                      <TableRow>
                        <TableCell sx={{ borderBottom: "none", p: 1, textAlign: 'left' }}>
                          <Typography variant="body1">Ingame: </Typography>
                        </TableCell>
                        <TableCell sx={{ borderBottom: "none", p: 1 }}>
