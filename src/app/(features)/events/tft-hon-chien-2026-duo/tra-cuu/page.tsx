...
export default function Page(): React.JSX.Element {
  const params = { event_slug: 'tft-hon-chien-2026-duo' }
      ...
      const fetchEventDetails = async () => {
        try {
          ...
          const [eventResponse, showsResponse]: [AxiosResponse<EventResponse>, AxiosResponse<Show[]>] = await Promise.all([
            ...
            baseHttpServiceInstance.get('/special_events/tft-2026-duo/shows'),
          ]);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res: AxiosResponse<SearchTransactionDTO> = await baseHttpServiceInstance.get('/special_events/tft-2026-duo/search-transaction', {
        params: {
          show_id: showId,
