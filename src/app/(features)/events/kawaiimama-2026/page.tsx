...
import { EventResponse } from './create-steps/types';

export const revalidate = 60; // revalidate every 60 seconds

// Route này là thư mục tĩnh (không phải [event_slug]) nên Next.js không truyền
// params.event_slug - luôn set cứng slug cho sự kiện Kawaii Mama.
...
export async function generateMetadata(
    ...
    const event = await fetchEvent(EVENT_SLUG).catch(() => null) as EventMeta | null;
    ...
    return {
        ...
        description,
        icons: {
            icon: '/assets/kawaiimama.png',
            shortcut: '/assets/kawaiimama.png',
            apple: '/assets/kawaiimama.png',
        },
        openGraph: {
            title,
            description,
...
export default async function EventPage() {
    ...
    return <EventDetail params={{ event_slug: EVENT_SLUG }} initialEvent={event} fetchError={fetchError} />;
}