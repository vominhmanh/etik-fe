...
export default function EventDetail({ params, initialEvent }: { params: { event_slug: string }, initialEvent: EventResponse | null }): React.JSX.Element {
  ...
  const [event, setEvent] = React.useState<EventResponse | null>(initialEvent);
  ...
  // Event details are now fetched on the server and passed as initialEvent
  ...
  const validateStep1 = () => {
    ...
    for (const ticket of order.tickets) {
      ...
      categoryQuantities[ticket.ticketCategoryId] = (categoryQuantities[ticket.ticketCategoryId] || 0) + 1;
    }
