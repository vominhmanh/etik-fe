...
import { CardMedia, Container, InputAdornment } from '@mui/material';
        ...
        <Stack spacing={3}>
          <Card>
            <CardMedia
              component="img"
              sx={{
                height: { xs: '150px', sm: '300px' }, // Height is auto on mobile (xs), and 300px on small screens and above (sm)
              }}
          ...
          <Stack direction="row" spacing={3}>
            <Stack spacing={1} sx={{ flex: '1 1 auto' }}>
              <Typography variant="h4">Sự kiện: {event?.name}</Typography>
            </Stack>
          </Stack>
          <Stack direction="row" spacing={3}>
          ...
          <Stack direction="row" spacing={3}>
            <Stack spacing={1} sx={{ flex: '1 1 auto' }}>
              <Typography variant="h6">Mua vé</Typography>
            </Stack>
          </Stack>
          <Grid container spacing={3}>
            <Grid item lg={4} md={6} xs={12}>
